...
def main() -> int:
    ...
    source_candidate, _ = process_script(source)
        ...
        json.dumps(
            {
                ...
                "status": "PASS_LINGUISTIC_HARDENING_REVIEW_READY",
                "episode_id": args.episode,
                "metrics": {
                ...
                "sample_before": report["sample_block"]["text_before"],
                "sample_after": report["sample_block"]["text_after"],
                "second_sample": {
