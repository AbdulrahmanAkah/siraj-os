...
def test_bundle_i_release_candidate_lifecycle():
 ...
 manifest=ReleasePackagingRuntime().manifest("0.1.0",[("siraj","WHEEL")]);report=ReleaseGovernance().verify({"architecture":True,"tests":True,"packaging":bool(manifest.artifacts)})
