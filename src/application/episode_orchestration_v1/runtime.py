...
def build_default_stage_registry() -> tuple[StageSpec, ...]:
    return (
        ...
        StageSpec("video_provider", "Video provider", "1", 105, "video_provider_v1", ("approved-storyboard", "generated-video-allocation-v1"), ("video-assets",), dependencies=("storyboard_approval",), external_provider_required=True, retry_policy="POLICY_GUARDED", current_implementation_status="DISCONNECTED"),
