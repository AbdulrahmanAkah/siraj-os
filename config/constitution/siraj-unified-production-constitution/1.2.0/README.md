...
- `SIRAJ_UNIFIED_PRODUCTION_CONSTITUTION_V1.md`: الدستور الموحد القابل للقراءة، الإصدار 1.2.0.
...
## 1.2.0 six-fix revision
النطاق: C2 + C3 + C6 + C8 + H3 + H4 فقط. C7 وبقية القواعد خارج النطاق ولم تُعدّل.
