# تدقيق توحيد دستور سراج وتصميم الإنفاذ — الإصدار 1.0.0
...
| CF-06 | منع النص داخل الفيديو مقابل Closed Captions | النص المحروق/الظاهر ممنوع؛ ملف Captions خارجي اختياري مسموح لأنه ليس جزءًا من الصورة | High | RESOLVED |
